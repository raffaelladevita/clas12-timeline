...
class ftof_time_noTriggers_p1a {
...
def close() {
  ...
  ['mean', 'sigma'].each{ name ->
    ...
    (0..<6).each{ sec->
      ...
      grtl.setTitle("p1a Vertex-time difference FTOF_vtime-RFT for e-, e+, pi-, and pi+ without triggers (" + name + ")")
      grtl.setTitleY("p1a Vertex-time difference FTOF_vtime-RFT for e-, e+, pi-, and pi+ without triggers (" + name + ") (ns)")
    ...
    out.writeFile('ftof_time_noTriggers_p1a_' + name + '.hipo')
  }
}
}
