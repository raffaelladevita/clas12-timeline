...
class ftof_edep_p1a_smallangles {
...
def write() {
  ...
  (0..<6).each{ sec->
    ...
    grtl.setTitle("p1a Pathlength Corrected Edep for e-, e+, pi-, and pi+, small angles (<= 11 deg)")
    grtl.setTitleY("p1a Pathlength Corrected Edep for e-, e+, pi-, and pi+, small angles (<= 11 deg) (MeV)")
