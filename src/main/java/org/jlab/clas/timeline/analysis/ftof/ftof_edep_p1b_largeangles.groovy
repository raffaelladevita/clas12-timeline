...
def write() {
  ...
  (0..<6).each{ sec->
    ...
    grtl.setTitle("p1b Path-length Corrected Edep for e-, e+, pi-, and pi+, large angles (>23 deg)")
    grtl.setTitleY("p1b Path-length Corrected Edep for e-, e+, pi-, and pi+, large angles (>23 deg) (MeV)")
